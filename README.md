...
* `CollectionSerializer` - use that serializer if you want to add meta with pagination info on response
...
* You can also create serializers for your own models using [serializer generator](https://github.com/rails-api/active_model_serializers/blob/master/README.md#creating-a-serializer)
